...
exports.transferBatch = async (request, response) => {
  ...
  try {
    ...
    const tx_builder = await contract.methods.safeBatchTransferFrom(fromAddress, to_address, tokenId, amount, '0x7B502C3A1F48C8609AE212CDFB639DEE39673F5E');
